...
export const WHITELISTED_TOKENS: string[] | '*' = _.isEmpty(process.env.WHITELIST_ALL_TOKENS)
    ? [
         '0x48cba8e7a873aa7740ed6ae035617a4c7f0711ee', // ZRX on Kovan
          '0xd0f219e2e0bb6d3b3d7fd8e2b141114932979478', // WETH on Kovan
          '0xfe4F5145f6e09952a5ba9e956ED0C25e3Fa4c7F1', //DummyERC20 on 80001
      ]
